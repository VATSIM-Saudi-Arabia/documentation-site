---
title: 2. Clearance Delivery
---

## 2.1 Clearances and read back requirements
...
### 2.2.1 General (Single Runway)
!!! Example
    **Controller**: "SAUDIA 123 CLEARED TO RIYADH AS FILE, EGREP3V DEPARTURE, INITIAL CLIMB 6000 FT, SQUAWK 2515"

    **Pilot**: "CLEARED TO RIYADH AS FILE, EGREP3V DEPARTURE, INITIAL CLIMB 6000 FT, SQUAWK 2515, SAUDIA 123"

    **Controller**: "SAUDIA 123, [READBACK] CORRECT, INFORMATION A, REPORT READY FOR
    PUSH AND START"

    **Pilot**: "INFORMATION A, WILCO, SAUDIA 123"

### 2.2.2 General (Dual Runway)
!!! Example
...
## 2.5 Aircraft unable an instruction
...
## 2.7 Omnidirectional or radar departures
...
### 2.7.1 Omnidirectional Departure
!!! Example
...
### 2.7.2 Radar Departure (Dammam Specific)
!!! Example
