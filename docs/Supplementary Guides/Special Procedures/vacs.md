...
- **Logout:** Logs you out of your connected VATSIM account within vacs. After logging out, logging into your VATSIM account will be nessecary, before using vacs again.
...
![Loading](img/prioActive.png#center)
