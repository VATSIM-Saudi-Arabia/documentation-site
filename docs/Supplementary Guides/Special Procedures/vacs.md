...
VACS (/vɐks/) is a free, open-source voice platform designed exclusively for VATSIM air traffic controllers. It streamlines coordination with neighboring sectors by removing the need for external accounts or third-party servers like Discord or TeamSpeak.
...
# **Installation**
## **Windows**
- Visit github.com/MorpheusXAUT/vacs/releases/latest
...
![Loading](img/settings_panel.png)
...
### **Always on Top**
This ensures that the VACS window is always visible
...
When another controller calls you, the relevant sector button will start indicating the incoming call.

![Loading](img/incoming_call.gif)
...
![Loading](img/tabbed_incoming_call_multiple.gif)
