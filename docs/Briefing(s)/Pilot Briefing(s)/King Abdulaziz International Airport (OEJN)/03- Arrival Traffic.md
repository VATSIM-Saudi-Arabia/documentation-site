...
### 1.1 Standard Terminal Arrival Routes (STARs)
Depending on the assigned stand, pilots may anticipate the following Standard Terminal Arrival Routes (STARs):
...
#### 1.1.3 Altitude Restrictions
All altitude restrictions on the STAR are mandatory and must be complied with unless otherwise instructed by ATC.

#### 1.1.4 Initial Contact
##### 1.1.4.1 Jeddah Approach
