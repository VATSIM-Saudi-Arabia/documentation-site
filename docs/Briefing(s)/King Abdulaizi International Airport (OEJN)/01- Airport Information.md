...
!!! success "Scope"
    This **pilot briefing** provides with essential in-flight operational information for **King Abdulaziz International Airport (OEJN)**
![Loading](imgs/oejn.png#center)
...
#### 1.1.3 Air Traffic Service
##### 1.1.4.1 ATS Airspace
...
#### 4.1.1 Radar Vectors on Downwind
...
### 4.3 Runway Operations
#### 4.3.1 Declared Distances (Landing)
...
#### 4.3.2 Minimum Runway Occupancy Time
...
#### 4.3.3 Standard Vacating Points
...
#### 4.4.1 Arrival Taxi Routes (ATRs)
