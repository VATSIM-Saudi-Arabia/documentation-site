...
- **Arrival traffic** shall be told the **expected runway exit point**, depending on their **parking apron**. For Apron 7, you must give them the **B3X** or the **B5X** arrival taxi route, depending if they vacate **B3 or B5**. After the **arriving traffic vacates the runway**, hand the traffic off to "*Jeddah Ground*" (OEJN_W_GND).
- **Arriving traffic** parking at **Apron 9** must be given the **B3X** or the **B5X** arrival taxi route, meaning they must vacate the **runway at B3 or B5**. After the arriving traffic vacates the runway, hand the traffic off to "*Jeddah Ground*" (OEJN_W_GND).
- **Arriving traffic** parking at **Apron 1, 2, 3, 4, 5** must be given the **B3X** or the **B5X** arrival taxi route, meaning they must vacate the **runway at B3 or B5**. After the arriving traffic vacates the runway, hand the traffic off to "*Jeddah Ground*" (OEJN_W_GND).
