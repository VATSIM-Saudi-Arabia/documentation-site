...
# OEJN_E_GND [SMC E] Briefing Material | Hajj OPS: 2026

!!! success "Covering"
    This section details all the necessary briefing materials for **OEJN_E_GND [SMC E]** during Hajj OPS: 2026
...
## Notes
### Arrival
- **Arrival** traffic going to **Apron A**, will contact you while taxing via the **M4X or M6X arrival taxi route**, and shall be taxied by "Jeddah Ground" to hold short **L5** and when **passing MB** shall contact "Jeddah Apron".
- **Arrival** traffic going to **Apron B**, will contact you while taxing via the **M7O arrival taxi route**, and shall be taxied by "Jeddah Ground" via **R, K to hold short K5** and when **passing HB** shall contact "Jeddah Apron".
- **Arrival** traffic going to **Apron C**, will contact you while taxing via the **M4X or M6X** arrival taxi route, and shall be taxied by "Jeddah Ground" via **V to hold short V2**, and when **passing V3** shall contact "Jeddah Apron".
